  ...
  navItems = [
    {
      ...
      routerLink: '',
      subMenu: [
        { label: 'About Patshala', routerLink: '/aboutus' },
        { label: 'Vision & Mission', routerLink: '/vision-mission' },
        {
          label: 'Our Team', 
          routerLink: '/ourteam', 
          subMenu: [
            { label: 'Leadership Team', routerLink: '/leadershipteam' },
            { label: 'Our Faculty', routerLink: '/ourfaculty' }
          ]
        }
      ]
    },
    {
      ...
      subMenu: [
        {
          label: 'CPC-Commerce Professional Courses',
          subMenu: [
            {
              label: 'Indian Courses',
              subMenu: [
                { label: 'CA', routerLink: '/ca' },
                { label: 'CMA', routerLink: '/cma' },
                { label: 'CS', routerLink: '/cs' }
              ]
            },
            {
              label: 'Global Courses',
              subMenu: [
                { label: 'ACCA (UK)', routerLink: '/acca' },
                { label: 'CIMA (UK)', routerLink: '/cima' },
                { label: 'CMA (USA)', routerLink: '/cmaus' },
                { label: 'CPA (USA)', routerLink: '/cpa' }
              ]
            }
          ]
        },
        {
          label: 'CEEC - Competitive Entrance Exam Courses',
          subMenu: [
            { label: 'LAW', subMenu: [
              { label: 'CLAT', routerLink: '/clat' },
              { label: 'SLAT', routerLink: '/slat' },
              { label: 'AILET', routerLink: '/ailet' }
            ]},
            { label: 'Management', subMenu: [
              { label: 'IPMAT', routerLink: '/ipmat' },
              { label: 'CAT', routerLink: '/cat' },
              { label: 'TS ICET', routerLink: '/tsicet' }
            ]}
          ]
        }
      ]
    },
    {
      ...
      routerLink: '',
      subMenu: [
        { label: 'Study Hub - Videos', routerLink: '/study_hub_videos' },
        { label: 'Online Live Classes', routerLink: '/online_live_classes' },
        { label: 'Live Classes Recordings', routerLink: '/recordedvideos' }
      ]
    },
    {
      ...
      routerLink: '',
      subMenu: [
        { label: 'New Batches Announcements', routerLink: '/newsandevents' },
        { label: 'Career Opportunities', routerLink: '/careeroppur' },
        { label: 'Exam Notifications', routerLink: '/examnotice' }
      ]
    },
    {
      label: 'Gallery',
    ...
    ...(this.isAdmin ? [
      {
        label: 'Admin',
        subMenu: [
          { label: 'Create Menu', routerLink: '/createmenu' },
          { label: 'View Enquiries', routerLink: '/view-enquiries' }
        ]
      }
    ] : [])
  ];
